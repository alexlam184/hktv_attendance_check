...
auth_df = pd.read_csv(r'./doc/auth.csv')
username = base64.b64decode(auth_df['username'][0]) # decode my base64 encoded username and password
password = base64.b64decode(auth_df['password'][0])
